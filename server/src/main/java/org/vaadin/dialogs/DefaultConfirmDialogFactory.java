...
public class DefaultConfirmDialogFactory implements Factory {
	...
	public ConfirmDialog create(final String caption, final String message, final String okCaption,
			final String cancelCaption, final String notOkCaption) {
	...
	/**
	 * This method allows overwriting the button order. It's provided with all three
	 * buttons of the dialog (out of which some can be null) and it returns a list
	 * of buttons in wanted order. This method can be overwritten to change the
	...
	/**
	 * Builds new "Not ok" button. This method can be used to overwrite the button
	 * building.
	 * 
